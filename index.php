...
function team_showcase_supreme_menu() {
   add_menu_page('WPM Team', 'WPM Team', 'manage_options', 'wpm-team-showcase', 'wpm_6310_home');
...
add_action('wp_ajax_wpm_6310_team_member_add', 'wpm_6310_team_member_add');
add_action('wp_ajax_wpm_6310_team_member_edit', 'wpm_6310_team_member_edit');
add_action('wp_ajax_wpm_6310_team_member_update', 'wpm_6310_team_member_update');
add_action('wp_ajax_wpm_6310_team_member_delete', 'wpm_6310_team_member_delete');
