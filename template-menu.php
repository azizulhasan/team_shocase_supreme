...
function wpm_template_01_10() {
   ...
   if (empty($_GET['styleid'])) {
      ...
      wp_enqueue_script('wpm-member-crud', plugins_url('assets/js/member-crud.js', __FILE__), array('jquery'));
      ...
      wp_enqueue_style('wpm-wpm-6310-owl-carousel', plugins_url('assets/css/owl.carousel.min.css', __FILE__));
       ...
       wp_enqueue_script('wpm-wpm-6310-jquery-ui', plugins_url('assets/js/jquery-ui.js', __FILE__), array('jquery'));
      wp_enqueue_style('wpm-wpm-6310-jquery-ui', plugins_url('assets/css/jquery-ui.css', __FILE__));
