...
jQuery(document).ready(function (e) {
  ...
  if ($allSlider[0]) {
    ...
    owlVar.on('mouseleave', function () {
      ...
      owlVar.trigger('play.owlVar.autoplay', [<?php echo $allSlider[2] ?>]);
    });
    let divHeight = jQuery(".wpm-6310-owl-height").attr("style");
    if(divHeight){
      divHeight = divHeight.split(":");
      if(divHeight[1]){
        divHeight = parseInt(divHeight[1]) + 20;
        jQuery(".wpm-6310-owl-height").css({'height' : divHeight + "px !important"});
      }
    }
    <?php
  }
...
<style>
  ...
  .wpm_6310_team_style_<?php echo $ids; ?>_readmore_text{    
    color: <?php echo $allSlider[23]?>;
    font-size: <?php echo $allSlider[22]?>px;
    width:<?php echo $allSlider[21]?>px;
    height:<?php echo $allSlider[20] + ($allSlider[25] * 2) + 1?>px;
  ...
  .wpm_6310_team_style_<?php echo $ids; ?>_readmore:hover .wpm_6310_team_style_<?php echo $ids; ?>_readmore_text{
