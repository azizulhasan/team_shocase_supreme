...
<?php include wpm_6310_plugin_url . 'settings/helper/category_form.php'; ?>
<script>
...
jQuery(document).ready(function () {
  ...
  jQuery("body").on("click", ".activate-slider", function () {
    ...
    jQuery("#wpm-6310-category-<?php echo $styleId ?>, #wpm-6310-category-carousel-<?php echo $styleId ?>").hide();
    if (val == 0) {
      jQuery("#wpm-6310-noslider-<?php echo $styleId ?>").show();
      jQuery("#wpm-6310-slider-<?php echo $styleId ?>").hide();
      if(category){
        jQuery("#wpm-6310-category-<?php echo $styleId ?>").show();
      }
    } else {
      jQuery("#wpm-6310-slider-<?php echo $styleId ?>").show();
      jQuery("#wpm-6310-noslider-<?php echo $styleId ?>").hide();
      if(category){
        jQuery("#wpm-6310-category-carousel-<?php echo $styleId ?>").show();
      }
    }
  });
