               ...
               <ul id="wpm-6310-sortable">
                  ...
                  foreach ($serials as $serial) {
                     foreach ($results as $result) {
                        if ($result['id'] == $serial) {
                           echo "<li class='ui-state-default wpm-6310-ui-state-default' id='{$serial}'>{$result['name']}</li>";
                           break;
                        }
                     }
                  }
...
?>
   <script>
      jQuery(document).ready(function() {
         jQuery('#wpm_jquery_heading_font, #wpm_jquery_designation_font, #wpm_jquery_heading_font_style1, #wpm_jquery_designation_font_style1, #wpm_jquery_heading_font_style, #wpm_jquery_designation_font_style, #wpm-front-end-load, #wpm_readmore_font_family, #wpm_category_font_family').fontselect();
      });
   </script>
<?php
}
...
?>
   ...
   <div id="mywpm_6310_modal_msg" class="wpm_6310_modal wpm_6310_modal_msg">
      <div class="wpm_6310_modal-content-msg">
         <span class="wpm-6310-close">&times;</span>
         <div id="wpm-msg"></div>
      </div>
      </div>   
