<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#wpm_box_shadow_width, #wpm_box_shadow_blur, #wpm_box_shadow_color").on("change", function () {
            ...
            jQuery("<style type='text/css'>.wpm_6310_team_style_26 .wpm_6310_team_style_26_team_content{ background:" + color + " !important;} </style>").appendTo(".wpm-preview-box");
        ...
        jQuery("#wpm_designation_font_size").on("change", function () {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'> .wpm_6310_team_style_26_designation { font-size:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        ...
        jQuery("#wpm_designation_line_height").on("change", function () {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'> .wpm_6310_team_style_26_designation { line-height:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        ...
        jQuery("#wpm_social_icon_height").on("change", function () {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'> .wpm_6310_team_style_26 .wpm_6310_team_style_26_social li a { height:" + value + "; line-height:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#wpm_social_border_width").on("change", function () {
            var value = jQuery(this).val() + "px !important";
            jQuery("<style type='text/css'>.wpm_6310_team_style_26 .wpm_6310_team_style_26_social li a { border-width:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        ...
        jQuery("#member_text_align").on("change", function () {
            var value = jQuery(this).val() ;
            jQuery("<style type='text/css'> .wpm_6310_team_style_26 .wpm_6310_team_style_26_title { text-align:" + value + ";} </style>").appendTo(".wpm_6310_tabs_panel_preview");
        });
        jQuery("#member_margin_top").on("change", function () {
            var value = jQuery(this).val() ;
            jQuery("<style type='text/css'> .wpm_6310_team_style_26 .wpm_6310_team_style_26_title { margin-top:" + value + "px;} </style>").appendTo(".wpm_6310_tabs_panel_preview");
        });
        jQuery("#member_margin_bottom").on("change", function () {
            var value = jQuery(this).val() ;
            jQuery("<style type='text/css'> .wpm_6310_team_style_26 .wpm_6310_team_style_26_title { margin-bottom:" + value + "px;} </style>").appendTo(".wpm_6310_tabs_panel_preview");
        });
         jQuery("#designation_text_align").on("change", function () {
            var value = jQuery(this).val() ;
            jQuery("<style type='text/css'> .wpm_6310_team_style_26 .wpm_6310_team_style_26_designation { text-align:" + value + ";} </style>").appendTo(".wpm_6310_tabs_panel_preview");
        });
