...
<div class="wpm-6310">
                  ...
                  <div class="wpm-6310-modal-body-form">
                     ...
                     <table border="0" width="100%" cellpadding="10" cellspacing="0">
                        ...
                        <tr>
                           ...
                           <td><input type="text" required="" name="serial" value="<?php echo $selCategory['serial'] ?>" class="wpm-form-input" /></td>
                        </tr>
                     </table>
   ...
   <table class="wpm-table">
      ...
      <?php
      $data = $wpdb->get_results('SELECT * FROM ' . $category_table . ' ORDER BY name ASC', ARRAY_A);
         ...
         <form action="" method="post">
            ...
            <div class="wpm-6310-modal-body-form">
               ...
               <table border="0" width="100%" cellpadding="10" cellspacing="0">
                  ...
                  <tr>
                     <td><label class="wpm-form-label" for="bgcolor">Category Serial:</label></td>
                     <td><input type="text" name="serial" class="wpm-form-input" placeholder="1, 2, 3"></td>
                  </tr>
               </table>
