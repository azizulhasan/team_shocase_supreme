...
if (!empty($_POST['submit']) && $_POST['submit'] == 'Save' && $_POST['style'] != '') {
   ...
   if (!wp_verify_nonce($nonce, 'wpm-nonce-field')) {
      ...
      if ($_POST['style'] == 'template-01') {
        $css = "4||0|0|rgba(255, 0, 0, 1)||nai|rgba(219, 219, 219, 0.96)|0|4|rgba(0, 0, 0, 0.4)|18|rgb(0, 0, 0)|rgb(0, 100, 0)||100|uppercase|Amaranth|26|14|rgb(152, 152, 152)|100|capitalize|Amaranth|20|rgb(0, 100, 0)|35|35|1||0";
        $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 255, 255, 1)|0|rgba(0, 150, 136, 1)|rgba(150, 0, 5, 1)|100|capitalize|center|Amaranth|0|20||||||center|0|10||||||||center|15|0||||||||";
        
     } else if ($_POST['style'] == 'template-02') {
        $css = "3||0|2|rgba(172, 19, 14, 1)|70|nai|rgba(51, 52, 62, 1)|0|0|rgba(255, 3, 3, 0.93)|18|rgb(255, 255, 255)|||500|uppercase|Amaranth|24|14|rgb(255, 255, 255)|200|capitalize|Amaranth|18||35|35|1||0";
        $slider .= "|1|Read More|30|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 255, 255, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|5|20||||||center|5|0||||||||center|0|0||||||||";
     } else if ($_POST['style'] == 'template-03') {
        $css = "3|scale(1.05)|0|0|rgba(255, 0, 0, 1)||nai|rgba(255, 255, 255, 1)|0|2|rgba(43, 42, 42, 0.25)|16|rgb(39, 39, 39)|rgb(0, 100, 0)||600|uppercase|Amaranth|22|14|rgb(152, 152, 152)|100|capitalize|Amaranth|20|rgb(0, 100, 0)|35|35|1||0";
        $slider .= "|1|Read More|30|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 33, 33, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|5|20||||||center|0|10||||||||center|10|0||||||||";
     } else if ($_POST['style'] == 'template-04') {
        $css = "3||0|0|rgba(29, 124, 207, 1)||nai|rgba(74, 74, 74, 0.65)|0|1|rgba(29, 124, 207, 0.83)|18|rgb(255, 255, 255)|rgb(31, 125, 207)|rgb(31, 125, 207)|600|uppercase|Amaranth|24|14|rgb(255, 255, 255)|200|capitalize|Amaranth|24||35|35|1||1";
        $slider .= "|1|Read More|35|180|20|rgba(0, 0, 0, 1)|rgba(255, 255, 255, 1)|none|rgba(245, 245, 245, 1)|2|rgba(62, 224, 208, 0.85)|rgba(89, 230, 185, 1)|100|capitalize|center|Allerta|5|20||||||center||||||||||center||||||||||";
     } else if ($_POST['style'] == 'template-05') {
        $css = "3|50%|0|2|rgba(168, 3, 0, 1)|90|nai|rgba(61, 61, 61, 1)|0|0|rgba(145, 0, 0, 1)|20|rgb(255, 255, 255)|||100|uppercase|Amaranth|24|14|rgb(255, 255, 255)|100|capitalize|Amaranth|20||35|35|1||1";
        $slider .= "|1|Read More|30|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 33, 33, 1)|2|rgba(204, 49, 90, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|5|20||||||center|5|0||||||||center|0|0||||||||";
     } else if ($_POST['style'] == 'template-06') {
        $css = "3|wpm_6310_eff_nul|0|2|rgba(148, 0, 0, 1)||nai|rgba(25, 25, 25, 0.8)|0|0|rgba(143, 0, 0, 1)|18|rgb(255, 255, 255)|||500|uppercase|Amaranth|24|14|rgb(255, 255, 255)|100|capitalize|Amaranth|20||35|35|1||0";
        $slider .= "|1|Read More|30|150|16|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|none|rgba(245, 245, 245, 1)|2|rgba(62, 224, 208, 0.85)|rgba(89, 230, 185, 1)|100|capitalize|center|Allerta|10|0||||||center|0|0||||||||center|0|15||||||||";
     } else if ($_POST['style'] == 'template-07') {
        $css = "3||0|2|rgba(158, 0, 0, 1)|70|nai|rgba(255, 255, 255, 1)|0|0|rgba(245, 0, 0, 1)|18|rgb(0, 0, 0)|||100|capitalize|Amaranth|28|14|rgb(0, 0, 0)|100|capitalize|Amaranth|18||35|35|1||1";
        $slider .= "|1|Read More|35|180|20|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|none|rgba(245, 245, 245, 1)|2|rgba(89, 230, 185, 1)|rgba(89, 230, 185, 1)|100|capitalize|center|Allerta|30|0||||||center|0|0||||||||center|6|0||||||||";
     } else if ($_POST['style'] == 'template-08') {
        $css = "3||0|2|rgba(244, 54, 98, 1)||nai|rgba(54, 206, 214, 1)|0|0|rgba(0, 40, 173, 1)|18|rgb(41, 41, 41)|||100|uppercase|Amaranth|24|14|rgb(115, 115, 115)|100|capitalize|Amaranth|20||35|35|1||0";
        $slider .= "|1|Read More|30|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(244, 54, 98, 1)|2|rgba(0, 150, 136, 1)|rgba(244, 54, 98, 1)|100|capitalize|center|Amaranth|5|20||||||center|5|0||||||||center|0|0||||||||";
     } else if ($_POST['style'] == 'template-09') {
        $css = "3||0|0|rgba(230, 126, 34, 1)||nai|rgba(39, 39, 39, 1)|0|0|rgba(84, 0, 0, 1)|18|rgb(255, 255, 255)|||600|uppercase|Amaranth|24|14|rgb(187, 187, 187)|200|capitalize|Amaranth|22||35|35|1||10";
        $slider .= "|1|Read More|30|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(3, 3, 3, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|5|15||||||center|20|0||||||||center|0|0||||||||";
     } else if ($_POST['style'] == 'template-10') {
        $css = "3||5|5|rgba(199, 20, 0, 0.89)||nai|rgba(230, 230, 230, 0.89)|5|12|rgba(230, 230, 230, 0.89)|18|rgb(0, 0, 0)|||100|capitalize|Tinos|28|18|rgb(41, 41, 41)|100|lowercase|Tinos|28||30|33|4||7";
        $slider .= "|1|Read More|35|180|20|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|none|rgba(245, 245, 245, 1)|2|rgba(74, 224, 146, 0.85)|rgba(86, 204, 167, 1)|100|capitalize|center|Allerta|5|10||||||center|0|0||||||||center|0|0||||||||";
     }
