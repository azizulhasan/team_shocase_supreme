<div class="wpm-6310">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      ...
                      <td>
                        <input type="text" name="member_bg_color" id="wpm_member_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo $allStyle[13] ?>">
                      </td>
                    </tr>
                    <tr height="45">
                    ...
                    <tr height="45">
                      ...
                      <td>
                        <input name="member_margin_bottom" id="member_margin_bottom" type="number" min="0"
                          value="<?php echo isset($allSlider[43])?($allSlider[43]):'20' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Background Color</b></td>
                      <td>
                        <input type="text" name="designation_bg_color" id="wpm_designation_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo $allStyle[14] ?>">
                      </td>
                    </tr>
                    <tr height="45">
                      <td width='55%'><b>Font Weight</b><?php //wpm_pro()                    
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Margin Top</b></td>
                      <td>
                        <input name="designation_margin_top" id="designation_margin_top" type="number" min="0" value="<?php echo isset($allSlider[52])? $allSlider[52] : '20' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr height="45">
                      <td><b>Margin Bottom</b></td>
  ...
  <style type="text/css">
    ...
    .wpm_6310_team_style_04 .wpm_6310_team_style_04_readmore_text {
      position:absolute;
      bottom: 10%;
      z-index: 999;
       width: <?php echo $allSlider[21] ?>px;
        ...
        <?php if ($allSlider[32] == 'center') {
          $width = intval($allSlider[21] /2) ;
        echo "margin-right:unset !important; margin-left: calc( 50% - {$width}px) !important;";
        echo "margin-left: auto;";
      } elseif ($allSlider[32] == 'right') {
        $width2 = intval($allSlider[21]);
        echo "margin-right: unset !important; margin-left: -calc( 50% - {$width2}px)   !important;";
      } elseif ($allSlider[32] == 'left') {
        echo "margin-right:unset !important; margin-left: 0% !important;";
      }
      ?>
      }
      .wpm_6310_team_style_04:hover .wpm_6310_team_style_04_readmore_text {
        bottom: -250px;
      }
      ...
      var width = Math.round(parseInt(jQuery("#readmore_width").val())/2);
      var width2 = Math.round(parseInt(jQuery("#readmore_width").val()));
      if (value == 'left') {
        jQuery("<style type='text/css'>.wpm_6310_team_style_04 .wpm_6310_team_style_04_readmore_text {margin-right:unset !important; margin-left: 0% !important; } </style>").appendTo(".wpm_6310_tabs_panel_preview");
      } else if (value == 'center') {
        jQuery("<style type='text/css'>.wpm_6310_team_style_04 .wpm_6310_team_style_04_readmore_text{margin-right:unset !important;margin-left: calc( 50% - "+ width +"px) !important;  } </style>").appendTo(".wpm_6310_tabs_panel_preview");
      } else if (value == 'right') {
        jQuery("<style type='text/css'>.wpm_6310_team_style_04 .wpm_6310_team_style_04_readmore_text{margin-right:unset !important; margin-left: -calc( 50% - "+ width2 +"px) !important; } </style>").appendTo(".wpm_6310_tabs_panel_preview");
      }

      jQuery("<style type='text/css'>.wpm_6310_team_style_04:hover ul.wpm_6310_team_style_04_social{bottom:<?php echo (isset($allSlider[18]) && $allSlider[18]) ? '30':'20'?>px;} </style>").appendTo(".wpm_6310_tabs_panel_preview");
    });
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_04  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_04  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                ...
                <div<?php echo $link_type ?>>
                  ...
                  <figcaption>
                    <div class="wpm_6310_team_style_04_caption">
                      <div class="wpm_6310_team_style_04_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                      <div class="wpm_6310_team_style_04_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                      <?php
                      ...
                      if ($icons) {
                        ...
                        foreach ($icons as $li) {
                          ...
                          if ($c == 0) {
                            echo "<ul class='wpm_6310_team_style_04_social'>";
                          }
                          $c++;
