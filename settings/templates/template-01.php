  ...
  <div class="wpm-6310-sm">
    ...
    <div class="wpm-plugin-setting-left">
                  ...
                  <table width="100%">
                    <tr height="45">
                      ...
                      <td>
                        ...
                        <span
                          class="btn btn-success btn-sm"><?php echo $allStyle[0] . (($allStyle[0] > 1) ? " items" : " item"); ?></span>
                    ...
                    <tr height="45">
                      ...
                      <td>
                        <input type="number" min="0" name="image_radius" value="<?php echo $allStyle[2] ?>"
                          class="wpm-form-input" id="wpm_image_radius" />
                      </td>
                    </tr>
                    <tr height="45">
      ...
      .wpm_6310_team_style_01 {
        ...
        box-shadow: 0 1px <?php echo $allStyle[9] ?>px <?php echo $allStyle[8] ?>px <?php echo $allStyle[10] ?>;
      }
      ...
      .wpm_6310_team_style_01:hover .wpm_6310_team_style_01_caption {
      ...
      .wpm_6310_team_style_01:hover {
        margin-top: -10px;
        margin-bottom: 10px;
        box-shadow: 0 5px <?php echo ($allStyle[9] * 5) ?>px <?php echo $allStyle[8] ?>px <?php echo $allStyle[10] ?>;
      }
          ...
          if ($members) {
            foreach ($members as $value) {
              ...
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_01 {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_01 {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_01' link-id='0' team-id='0'";
              }
          ?>
           <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
            <div<?php echo $link_type ?>>
            <div class="wpm_6310_image_actions">
                <img src="<?php echo $value['image'] ?>" alt="<?php echo $value['name'] ?>">
                <?php //echo wpm_member_actions($value['id']) ?>
              </div>
              <figcaption>
                <div class="wpm_6310_team_style_01_caption">
                  <div class="wpm_6310_team_style_01_designation"><?php echo $value['designation'] ?></div>
                  <div class="wpm_6310_team_style_01_title"><?php echo $value['name'] ?></div>
                  <?php
                  if($value['iconids']) {
                      ...
                      if ($icons) {
                        ...
                        foreach ($icons as $li) {
                          ...
                          if ($c == 0) {
                            echo "<ul class='wpm_6310_team_style_01_social'>";
                          }
                          $c++;
...
<?php wpm_6310_modal_settings_for_member_description($loading, $template_id); ?>
