  ...
  <div class="wpm-6310-sm">
    ...
    <div class="wpm-plugin-setting-left">
              ...
              <div class="row wpm_6310_padding_15_px">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td width="55%"><b>Image Background</b>
                      </td>
                      <td>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Font Hover Color</b></td>
                      <td>
                        <input type="text" name="designation_font_hover_color" id="wpm_designation_font_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo $allStyle[14] ?>">
                      </td>
                    </tr>
                    <tr height="45">
                      <td width='55%'><b>Font Weight</b><?php //wpm_pro()                                                              
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_17_designation {
          display: block;
        ...
        .wpm_6310_team_style_17_description {
          font-size: 14px;
          line-height: 22px;
          color: <?php echo $allStyle[12] ?>;
          transition: all 0.8s ease 0s;
        ...
        .wpm_6310_team_style_17:hover .wpm_6310_team_style_17_description,
      ...
      jQuery('body').on("click", ".activate-readmore", function() {
        var value = jQuery(this).val();
          if(value == '1'){
              jQuery(".wpm_6310_team_style_17_description").hide();
            }else{
              jQuery(".wpm_6310_team_style_17_description").show();
            }
          })
        })
      </script>
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_17  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_17  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_17' link-id='0' team-id='0'";
              }
              ...
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type ?>>
                    ...
                    <div class="wpm_6310_team_style_17_pic">
                      ...
                      if ($icons) {
                        ...
                        foreach ($icons as $li) {
                          ...
                          if ($c == 0) {
                            echo "<ul class='wpm_6310_team_style_17_social'>";
                          }
                          $c++;
                  ...
                  <div class="wpm_6310_team_style_17_team_content">
                    <div class="wpm_6310_team_style_17_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_17_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                    <div class="wpm_6310_team_style_17_description"><?php echo wpm_6310_wordcount($value['profile_details'], 12) ?></div>
