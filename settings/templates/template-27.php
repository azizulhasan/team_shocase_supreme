    ...
    <div class="wpm-plugin-setting-left">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      ...
                      <td>
                        <input name="member_margin_top" id="member_margin_top" type="number" min="0" value="<?php echo isset($allSlider[42])?($allSlider[42]):'15' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr height="45">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Margin Top</b></td>
                      <td>
                        <input name="designation_margin_top" id="designation_margin_top" type="number" min="0" value="<?php echo isset($allSlider[52])? $allSlider[52] : '5' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr height="45">
                      <td><b>Margin Bottom</b></td>
                      <td>
                        <input name="designation_margin_bottom" id="designation_margin_bottom" type="number" min="0"
                          value="<?php echo isset($allSlider[53])? $allSlider[53] : '10' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_27:hover .wpm_6310_team_style_27_social {
          background-color: <?php echo $allStyle[7] ?>;
          opacity: 1;
          bottom: <?php echo (($allStyle[18]+$allStyle[24]+$allSlider[20]+$allSlider[42]+$allSlider[43]+$allSlider[52]+$allSlider[53]+$allSlider[34]+$allSlider[35]));?>px;
        }
      ...
      jQuery(document).ready(function() {
        jQuery("#readmore_height, #readmore_margin_top,#wpm_designation_line_height, #wpm_heading_line_height, #readmore_margin_bottom,  #member_margin_top, #member_margin_bottom, #designation_margin_top, #designation_margin_bottom").on("change", function () {
          var value1 = parseInt(jQuery("#readmore_height").val());
          var value2 = parseInt(jQuery("#readmore_margin_top").val());
          var value3 = parseInt(jQuery("#readmore_margin_bottom").val());
          var value5 = parseInt(jQuery("#member_margin_top").val());
          var value6 = parseInt(jQuery("#member_margin_bottom").val());
          var value8 = parseInt(jQuery("#designation_margin_top").val());
          var value9 = parseInt(jQuery("#designation_margin_bottom").val());
          var value4 = parseInt(jQuery("#wpm_designation_line_height").val());
          var value7 = parseInt(jQuery("#wpm_heading_line_height").val());
          jQuery("<style type='text/css'>.wpm_6310_team_style_27:hover .wpm_6310_team_style_27_social { bottom:unset !important; bottom:" + ((value1+value2+value3+value5+value6+value8+value9+value4+value7)+1) + "px !important;} </style>").appendTo(".wpm_6310_tabs_panel_preview");
        });
          ...
          if ($members) {
            ...
            $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_27  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_27  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_27' link-id='0' team-id='0'";
              }
              $col++;
              if ($col % $allStyle[0] == 1) {
                ...
                <div<?php echo $link_type ?>>
                  ...
                  if ($icons) {
                    ...
                    foreach ($icons as $li) {
                      ...
                      if ($c == 0) {
                        echo "<ul class='wpm_6310_team_style_27_social'>";
                      }
                      $c++;
                  ...
                  <div class="wpm_6310_team_style_27_team_content">
                    <div class="wpm_6310_team_style_27_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_27_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                    <?php wpm_6310_readmore_activation($template_id, $value['profile_details_type'], $allSlider[19]); ?>
