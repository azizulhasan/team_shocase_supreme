    ...
    <div class="wpm-plugin-setting-left">
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_21  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_21  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_21' link-id='0' team-id='0'";
              }
              ...
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type ?>>
                  ...
                  <div class="wpm_6310_team_style_21_team_content">
                    <div class="wpm_6310_team_style_21_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_21_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                    ...
                    if ($icons) {
                      ...
                      foreach ($icons as $li) {
                        ...
                        ul.wpm_6310_team_style_21_social li a#wpm-social-link-{$value['id']}-{$li['id']}:before{
                          content: '';
                          width: 100%;
                          height: 100%;
                          position: absolute;
                        ...
                        ul.wpm_6310_team_style_21_social li:hover a#wpm-social-link-{$value['id']}-{$li['id']}{
                          color: {$li['bgcolor']};
                        }
                        ul.wpm_6310_team_style_21_social li:hover a#wpm-social-link-{$value['id']}-{$li['id']}:before{
