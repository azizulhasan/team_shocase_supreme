    ...
    <div class="wpm-plugin-setting-left">
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_12_team_content:before {
          content: "";
          border-bottom: 30px <?php echo $allStyle[7] ?> solid;
        ...
        .wpm_6310_team_style_12_title:after {
          ...
          display: block;
          width: 10%;
          border-bottom: 4px <?php echo $allStyle[12] ?> solid;
          padding-bottom: 5px;
        ...
        .wpm_6310_team_style_12_description {
          color: <?php echo $allStyle[12] ?>;
          font-size: 14px;
          line-height: 20px;
          letter-spacing: .1em;
        ...
        .wpm_6310_team_style_12_description:after {
          content: "";
          display: <?php echo (isset($allSlider[18])  && $allSlider[18])? "none":'block'  ?>;
          border-bottom: 1px solid <?php echo $allStyle[12] ?>;
          margin-top: 10px;
        }
     ...
     <script type="text/javascript">
      ...
      jQuery('body').on("click", ".activate-readmore", function() {
        var value = jQuery(this).val();
          if(value == '1'){
              jQuery(".wpm_6310_team_style_12_description").hide();
              jQuery("<style>.wpm_6310_team_style_12_team_content{bottom:-60%}</style>").appendTo('.wpm_6310_tabs_panel_preview');
            }else{
              jQuery(".wpm_6310_team_style_12_description").show();
               jQuery("<style>.wpm_6310_team_style_12_team_content{bottom:-75%}</style>").appendTo('.wpm_6310_tabs_panel_preview');
            }
          })
        })
      </script>
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_12  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_12  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
              ...
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type ?>>
                  ...
                  <div class="wpm_6310_team_style_12_team_content">
                    <div class="wpm_6310_team_style_12_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_12_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>

                    <div class="wpm_6310_team_style_12_description"><?php echo wpm_6310_wordcount($value['profile_details'], 12) ?></div>
                    ...
                    if ($icons) {
                      ...
                      foreach ($icons as $li) {
                        ...
                        if ($c == 0) {
                          echo "<ul class='wpm_6310_team_style_12_social'>";
                        }
                        $c++;
