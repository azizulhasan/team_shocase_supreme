   ...
   <div class="wpm-6310-sm">
      ...
      <div class="wpm-plugin-setting-left">
         ...
         <style type="text/css">
            ...
            .wpm_6310_team_style_08_readmore_text{
            ...
            .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_readmore_text{
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
                     if ($value['profile_details_type'] == 1) {
                        $link_type = " class='wpm_6310_team_style_08  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
                     } else if ($value['profile_details_type'] == 2) {
                        $link_type = " class='wpm_6310_team_style_08  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
                     } else {
                     ...
                     <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                        <div<?php echo $link_type ?>>
                           ...
                           <div class="wpm_6310_team_style_08_team_content">
                              <h3 class="wpm_6310_team_style_08_title"><?php echo wpm_6310_replace($value['name']) ?></h3>
                              <div class="wpm_6310_team_style_08_border"></div>
                              <span class="wpm_6310_team_style_08_designation"><?php echo wpm_6310_replace($value['designation']) ?></span>
                              <?php
                              ...
                              if ($icons) {
                                 ...
                                 foreach ($icons as $li) {
                                    ...
                                    if ($c == 0) {
                                       echo "<ul class='wpm_6310_team_style_08_social'>";
                                    }
                                    $c++;
