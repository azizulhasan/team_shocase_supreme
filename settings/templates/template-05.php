  ...
  <div class="wpm-6310-sm">
    ...
    <div class="wpm-plugin-setting-left">
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_05:hover .wpm_6310_team_style_05_pic:after {
          ...
          top: <?php echo  ($allStyle[5]=='100')?'0':((100-($allStyle[5]))/2)?>% !important;
          bottom: <?php echo  ($allStyle[5]=='100')?'0':((100-($allStyle[5]))/2)?>% !important;
        ...
        .wpm_6310_team_style_05_team_content {
          ...
          top: <?php echo (isset($allSlider[18])&& $allSlider[18])?25:30; ?>%;
        }
    ...
    jQuery(document).ready(function(){
      ...
      jQuery("body").on('change', '#wpm_image_overlay', function(){
        ...
        var overlay_val =Math.round((overlay==100)?0:(100-overlay)/2);
        jQuery("<style>.wpm_6310_team_style_05:hover .wpm_6310_team_style_05_pic:after{ height:"+overlay+"%; top:"+(overlay_val)+"%!important;  bottom:"+(overlay_val)+"% !important;}</style>").appendTo(".wpm_6310_tabs_panel_preview");
      })
      jQuery('body').on('click', '.activate-readmore', function(){
        let value = jQuery(this).val();
        if(value=='1'){
          jQuery("<style>.wpm_6310_team_style_05_team_content{ top:25% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
        }else{
          jQuery("<style>.wpm_6310_team_style_05_team_content{ top:30% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
        }
      })
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_05  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_05  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
              ...
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type ?>>
                  ...
                  <div class="wpm_6310_team_style_05_team_content">
                    <div class="wpm_6310_team_style_05_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_05_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                    <?php
