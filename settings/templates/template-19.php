  ...
  <div class="wpm-6310-sm">
    ...
    <div class="wpm-plugin-setting-left">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Margin Top</b></td>
                      <td>
                        <input name="designation_margin_top" id="designation_margin_top" type="number" min="0" value="<?php echo isset($allSlider[52])? $allSlider[52] : '10' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr height="45">
                      <td><b>Margin Bottom</b></td>
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_19_designation:before {
          content: "";
          display: block;
          width: 7px;
          height: 7px;
      ...
      <script type="text/javascript">
        jQuery(document).ready(function(){
          // alert('hasan')
          jQuery("#member_margin_bottom , #designation_margin_top").on("change", function(){
            var mm_bottom = parseInt(jQuery("#member_margin_bottom").val());
            var dm_top = parseInt(jQuery("#designation_margin_top").val());
            // console.log(mm_bottom+" , "+dm_top)

            if(dm_top>0){
              var sum = dm_top+mm_bottom;
                jQuery("<style>.wpm_6310_team_style_19_designation:before{top:-"+(sum-5)+"px;}</style>").appendTo(".wpm_6310_tabs_panel_preview");
            }else{
              jQuery("<style>.wpm_6310_team_style_19_designation:before{top:-"+(mm_bottom-5)+"px;}</style>").appendTo(".wpm_6310_tabs_panel_preview");
            }
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_19  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_19  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_19' link-id='0' team-id='0'";
              }
             ?>
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type ?>>
                  <div class="wpm_6310_team_style_19_pic">
                    ...
                    if ($icons) {
                      ...
                      foreach ($icons as $li) {
                        ...
                        if ($c == 0) {
                          echo "<ul class='wpm_6310_team_style_19_social'>";
                        }
                        $c++;
                  ...
                  <div class="wpm_6310_team_style_19_team_content">
                    <div class="wpm_6310_team_style_19_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_19_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
