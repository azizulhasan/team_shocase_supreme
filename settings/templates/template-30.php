    ...
    <div class="wpm-plugin-setting-left">
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_30_team_content {
          ...
          border-top: 20px solid <?php echo $allStyle[10] ?>;
          border-bottom: 20px solid <?php echo $allStyle[10] ?>;
          overflow: hidden;
          float: left;
          display: table;
          z-index: 1;
      ...
      jQuery('body').on("click", ".activate-readmore", function() {
        var value = jQuery(this).val();
          if(value == '1'){
              jQuery(".wpm_6310_team_style_30_description").hide();
              
            }else{
              jQuery(".wpm_6310_team_style_30_description").show();
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_30  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_30  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_30' link-id='0' team-id='0'";
              }
                ...
                <div<?php echo $link_type ?>>
                  ...
                  <div class="wpm_6310_team_style_30_team_content">
                    <div class="wpm_6310_team_style_30_box_content">
                      <div class="wpm_6310_team_style_30_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                      <div class="wpm_6310_team_style_30_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                      <div class="wpm_6310_team_style_30_description"><?php echo wpm_6310_wordcount($value['profile_details'], 12) ?></div>
                      ...
                      if ($icons) {
                        ...
                        foreach ($icons as $li) {
                          ...
                          if ($c == 0) {
                            echo "<ul class='wpm_6310_team_style_30_social'>";
                          }
                          $c++;
