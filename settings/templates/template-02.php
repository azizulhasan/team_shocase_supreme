...
<div class="wpm-plugin-setting-left">
          ...
          <div class="row wpm_6310_padding_15_px">
            ...
            <div class="wpm-col-6">
              <table class="table table-responsive wpm_6310_admin_table">
                <tr height="45">
                  <td width="55%"><b>Image Hover Background</b><?php //wpm_pro()   ?></td>
                  <td>
          ...
          <div class="row">
            <div class="wpm-col-6">
              <table class="table table-responsive wpm_6310_admin_table">
                ...
                <tr height="45">
                  <td width='55%'><b>Font Weight</b><?php //wpm_pro() ?></td>
                  <td>
                ...
                <tr height="45" >
                  <td><b>Member Text Align</b><?php ?></td>
                  <td>
            ...
            <div class="wpm-col-6">
              <table class="table table-responsive wpm_6310_admin_table">
                ...
                <tr height="45">
                  <td><b>Font Family</b><?php //wpm_pro()?></td>
                  <td>
                ...
                <tr height="45">
                  ...
                  <td>
                    <input name="member_margin_top" id="member_margin_top" type="number" min="0" value="<?php echo isset($allSlider[42])?($allSlider[42]):'5' ?>" class="wpm-form-input" />
                  </td>
                </tr>
                <tr height="45">
          ...
          <div class="row">
            <div class="wpm-col-6">
              <table class="table table-responsive wpm_6310_admin_table">
                ...
                <tr height="45" >
                  <td><b>Designation Text Align</b><?php ?></td>
                  <td>
        ...
        <div id="tab-4">
          <div class="row">
            ...
            <div class="wpm-col-6">
              <table class="table table-responsive wpm_6310_admin_table">
                <tr height="45">
                  <td width="55%"><b>Social Icon Border Width</b><?php //wpm_pro()  ?></td>
                  <td>
  ...
  <style type="text/css">
    .wpm_6310_team_style_02 {
      ...
      -o-border-radius: <?php echo $allStyle[2] ?>%;F
  ...
  <script type="text/javascript">
    jQuery(document).ready(function(){
      ...
      jQuery("body").on('change', '#wpm_image_overlay', function(){
        ...
        var overlay_val = (overlay==100)?0:(100-overlay);
        if(readmore==1){
                jQuery("<style>.wpm_6310_team_style_02:hover .wpm_6310_team_style_02_pic:after{height:"+overlay+"%; top:"+(overlay_val)+"%;bottom:0;}</style>").appendTo(".wpm_6310_tabs_panel_preview");
              if(overlay_val==0 ){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:25%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay_val==10){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:30%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay_val==20){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:35%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay_val==30){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:40%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay_val==40){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:45%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else{
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:50%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }
        }else{
          jQuery("<style>.wpm_6310_team_style_02:hover .wpm_6310_team_style_02_pic:after{height:"+overlay+"%; top:"+overlay_val+"%;;bottom:0;  }</style>").appendTo(".wpm_6310_tabs_panel_preview");
          if(overlay_val==0 ){
                ...
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:43% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay_val==30){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:45% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay_val==40){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:53% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else{
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:60% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }   
            } 
          })
      jQuery('body').on('click', '.activate-readmore', function(){
        ...
        let top = (overlay==100)?0:(100-overlay);
        if(value=='1'){
               if(top==0 ){
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:25% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(top==10){
           ...
           if(top==0 ){
                ...
                jQuery("<style>.wpm_6310_team_style_02_team_content{ top:55% }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }
          }
      })
    })
      ...
      if ($members) {
        foreach ($members as $value) {
          ...
          if ($value['profile_details_type'] == 1) {
            $link_type = " class='wpm_6310_team_style_02  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
          } else if ($value['profile_details_type'] == 2) {
            $link_type = " class='wpm_6310_team_style_02  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
          } else {
            $link_type = " class='wpm_6310_team_style_02' link-id='0' team-id='0'";
          }
      ?>
         ...
         <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
            <div<?php echo $link_type ?>>
              ...
              <div class="wpm_6310_team_style_02_team_content">
                <div class="wpm_6310_team_style_02_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                <div class="wpm_6310_team_style_02_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                <?php
                ...
                if ($icons) {
                  ...
                  foreach ($icons as $li) {
                    ...
                    if ($c == 0) {
                      echo "<ul class='wpm_6310_team_style_02_social'>";
                    }
                    $c++;
