   ...
   <div class="wpm-6310-sm">
      ...
      <div class="wpm-plugin-setting-left">
                           ...
                           <table class="table table-responsive wpm_6310_admin_table">
                              ...
                              <tr height="45">
                                 ...
                                 <td>
                                    ...
                                    value="<?php echo isset($allSlider[53])? $allSlider[53] : '15' ?>" class="wpm-form-input" />
                                 </td>
                              </tr>
                           </table>
                        </div>
         ...
         <style type="text/css">
            ...
            .wpm_6310_team_style_06_designation {
               ...
               margin-bottom: <?php echo isset($allSlider[53])?$allSlider[53]:'15' ?>px; 
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
                     if ($value['profile_details_type'] == 1) {
                        $link_type = " class='wpm_6310_team_style_06  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
                     } else if ($value['profile_details_type'] == 2) {
                        $link_type = " class='wpm_6310_team_style_06  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
                     } else {
                        $link_type = " class='wpm_6310_team_style_06' link-id='0' team-id='0'";
                     }
                        ...
                        <div<?php echo $link_type ?>>
                           ...
                           <figcaption>
                              <div class="wpm_6310_team_style_06_content">
                                 <div class="wpm_6310_team_style_06_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                                 <div class="wpm_6310_team_style_06_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                                 <?php
                                 ...
                                 if ($icons) {
                                    ...
                                    foreach ($icons as $li) {
                                       ...
                                       if ($c == 0) {
                                          echo "<ul class='wpm_6310_team_style_06_social'>";
                                       }
                                       $c++;
