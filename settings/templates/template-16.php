    ...
    <script type="text/javascript">
      ...
      jQuery('body').on("click", ".activate-readmore", function() {
        var value = jQuery(this).val();
          if(value == '1'){
              jQuery(".wpm_6310_team_style_16_description").hide();
            }else{
              jQuery(".wpm_6310_team_style_16_description").show();
            }
          })
        })
      </script>
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_16  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_16  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_16' link-id='0' team-id='0'";
              }
              ...
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type ?>>
                  <div class="wpm_6310_team_style_16_pic">
                    ...
                    <?php echo $allStyle[1] ?>" alt="<?php echo wpm_6310_replace($value['name']) ?>">
                    ...
                    <div class="wpm_6310_team_style_16_social_team">
                      ...
                      if ($icons) {
                        ...
                        foreach ($icons as $li) {
                          ...
                          if ($c == 0) {
                            echo "<ul class='wpm_6310_team_style_16_social'>";
                          }
                          $c++;
                  ...
                  <div class="wpm_6310_team_style_16_team_content">
                    <div class="wpm_6310_team_style_16_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_16_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                    <div class="wpm_6310_team_style_16_description"><?php echo wpm_6310_wordcount($value['profile_details'], 12) ?></div>
