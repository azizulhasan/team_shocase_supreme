...
<style type="text/css">
    ...
    .wpm_6310_team_style_24 .wpm_6310_team_style_24_readmore{
        display:none !important;
        transition: all 0.8s ease 0s;
    }
    .wpm_6310_team_style_24:hover .wpm_6310_team_style_24_readmore{
    ...
    if(value == '1'){
        jQuery(".wpm_6310_team_style_24_readmore").show();
        jQuery("<style>.wpm_6310_team_style_24:hover .wpm_6310_team_style_24_team_content {top:60%;}</style>").appendTo('.wpm_6310_tabs_panel_preview');
        }else{
        jQuery(".wpm_6310_team_style_24_readmore").hide();
        jQuery("<style>.wpm_6310_team_style_24:hover .wpm_6310_team_style_24_team_content {top:75%;}</style>").appendTo('.wpm_6310_tabs_panel_preview');
            }
        })
    })
    </script>
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
                            if ($value['profile_details_type'] == 1) {
                                $link_type = " class='wpm_6310_team_style_24  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
                            } else if ($value['profile_details_type'] == 2) {
                                $link_type = " class='wpm_6310_team_style_24  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
                            } else {
                                $link_type = " class='wpm_6310_team_style_24' link-id='0' team-id='0'";
                            }
                                ...
                                <div<?php echo $link_type ?>>
                                    ...
                                    if ($icons) {
                                        ...
                                        foreach ($icons as $li) {
                                            ...
                                            if ($c == 0) {
                                                echo "<ul class='wpm_6310_team_style_24_social'>";
                                            }
                                            $c++;
                                    ...
                                    <div class="wpm_6310_team_style_24_team_content">
                                        <div class="wpm_6310_team_style_24_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                                        <div class="wpm_6310_team_style_24_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
