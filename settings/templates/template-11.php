    ...
    <div class="wpm-plugin-setting-left">
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                ...
                $link_type = " class='wpm_6310_team_style_11  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
              ...
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type; ?>>
                  <div class="">
                    ...
                    <?php
                    if (trim($value['name'])) {
                      echo "<div class='wpm_6310_team_style_11_title'>{$value['name']}</div>";
                    }
                    ?>
                  </div>
                  <div class="effect-appearance-class <?php echo $allStyle[1] ?>">
                    <div class="wpm_6310_team_style_11_table">
                      <div class="wpm_6310_team_style_11_table_cell">
                        <?php
                        if (trim($value['name'])) {
                          echo "<div class='wpm_6310_team_style_11_title_hover'>{$value['name']}</div>";
                        }
                        if (trim($value['designation'])) {
                          echo "<div class='wpm_6310_team_style_11_designation_hover'>{$value['designation']}</div>";
                        }
                        ?>
                        <?php
                        ...
                        if ($icons) {
                          ...
                          foreach ($icons as $li) {
                            ...
                            if ($c == 0) {
                              echo "<ul class='wpm_6310_team_style_11_social'>";
                            }
                            $c++;
