  ...
  <div class="wpm-6310-sm">
    ...
    <div class="wpm-plugin-setting-left">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      ...
                      <td>
                        <input name="member_margin_top" id="member_margin_top" type="number" min="20" value="<?php echo isset($allSlider[42])?($allSlider[42]):'0' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr height="45">
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_15_description {
          font-size: 14px;
          line-height: 1.5em;
          color: <?php echo $allStyle[12] ?>;
          margin-bottom: 10px;  
      ...
      jQuery('body').on("click", ".activate-readmore", function() {
        var value = jQuery(this).val();
          if(value == '1'){
              jQuery(".wpm_6310_team_style_15_description").hide();
              jQuery("<style>.wpm_6310_team_style_15_team_content{bottom:-60%}</style>").appendTo('.wpm_6310_tabs_panel_preview');
            }else{
              jQuery(".wpm_6310_team_style_15_description").show();
               jQuery("<style>.wpm_6310_team_style_15_team_content{bottom:-75%}</style>").appendTo('.wpm_6310_tabs_panel_preview');
            }
          })
        })
      </script>
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_15  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_15  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                $link_type = " class='wpm_6310_team_style_15' link-id='0' team-id='0'";
              }
              ...
              <div class="wpm-6310-col-<?php echo "{$allStyle[0]} wpm-6310-category-filter {$value['category']}" ?>">
                <div<?php echo $link_type ?>>
                  ...
                  <div class="wpm_6310_team_style_15_team_content">
                    <div class="wpm_6310_team_style_15_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                    <div class="wpm_6310_team_style_15_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                    <div class="wpm_6310_team_style_15_description"><?php echo wpm_6310_wordcount($value['profile_details'], 12) ?></div>
                    <?php
                    ...
                    if ($icons) {
                      ...
                      foreach ($icons as $li) {
                        ...
                        if ($c == 0) {
                          echo "<ul class='wpm_6310_team_style_15_social'>";
                        }
                        $c++;
