<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    if (!empty($_POST['update_style_change']) && $_POST['update_style_change'] == 'Save' && $_POST['styleid'] != '') {
      ...
      if (!wp_verify_nonce($nonce, 'wpm_nonce_field_form')) {
        ...
        $css .= "|" . sanitize_text_field($_POST['wpm_image_overlay']);
        //0 - 5
    ...
    <div class="wpm-plugin-setting-left">
              ...
              <div class="row wpm_6310_padding_15_px">
                <div class="wpm-col-6">
                  <table width="100%">
                    ...
                    <tr height="45" >
                  <td><b>Image Ovelay</b><?php ?></td>
                  <td>
                    <select name="wpm_image_overlay" class="wpm-form-input" id="wpm_image_overlay">
                      <option value="50" <?php if ($allStyle[5] == '50') echo " selected=''" ?>>
                        50%</option>
                      <option value="60" <?php if ($allStyle[5] == '60') echo " selected=''" ?>>60%
                      </option>
                      <option value="70" <?php if ($allStyle[5] == '70') echo " selected=''" ?>>70%
                      <option value="80" <?php if ($allStyle[5] == '80') echo " selected=''" ?>>80%
                      <option value="90" <?php if ($allStyle[5] == '90') echo " selected=''" ?>>90%
                      <option value="100" <?php if ($allStyle[5] == '100') echo " selected=''" ?>>100%
                      </option>
                    </select>
                  </td>
                </tr>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      ...
                      <td>
                        <input name="member_margin_top" id="member_margin_top" type="number" min="0" value="<?php echo isset($allSlider[42])?($allSlider[42]):'0' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr height="45">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Margin Top</b></td>
                      <td>
                        <input name="designation_margin_top" id="designation_margin_top" type="number" min="0" value="<?php echo isset($allSlider[52])? $allSlider[52] : '6' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr height="45">
                      <td><b>Margin Bottom</b></td>
                      <td>
                        <input name="designation_margin_bottom" id="designation_margin_bottom" type="number" min="0"
                          value="<?php echo isset($allSlider[53])? $allSlider[53] : '0' ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
      ...
      <?php
    function wmp_07_wmp_07_content_position($readmore = '',$overlay ='' ){
  ...
  ?>
      ...
      <style type="text/css">
       ...
       .wpm_6310_team_style_07 figcaption .wpm_6310_team_style_07_content{
          width: 100%;
          position: absolute;
          left: 0;
          opacity: 1;
        ...
        .wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{
          top: <?php wmp_07_content_position($allSlider[18] ,$allStyle[5]) ?>%;
        }
    ...
    jQuery(document).ready(function(){
      let readmore = jQuery("#readmore_activation").val();
      jQuery("body").on('change', '#wpm_image_overlay', function(){
         var  overlay = parseInt(jQuery(this).val());
        if(readmore==1){
                jQuery("<style>.wpm_6310_team_style_07:hover figcaption {height:"+overlay+"%; top:"+(100-overlay)+"%;}</style>").appendTo(".wpm_6310_tabs_panel_preview");
              if(overlay==100 ){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:20%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==90){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:17%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==80){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:12%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==70){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:9%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==60){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:6%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else{
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:3%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }
        }else{
          jQuery("<style>.wpm_6310_team_style_07:hover figcaption {height:"+overlay+"%; top:"+(100-overlay)+"%;}</style>").appendTo(".wpm_6310_tabs_panel_preview");
          if(overlay==100 ){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:30%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==90){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:25%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==80){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:20%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==70){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:18%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==60){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:17%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else{
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:10%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }
            } 
          })
      jQuery('body').on('click', '.activate-readmore', function(){
        let readmore = jQuery(this).val();
        let overlay = parseInt(jQuery("#wpm_image_overlay").val());
        if(readmore==1){
                jQuery("<style>.wpm_6310_team_style_07:hover figcaption {height:"+overlay+"%; top:"+(100-overlay)+"%;}</style>").appendTo(".wpm_6310_tabs_panel_preview");
              if(overlay==100 ){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:20%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
          ...
          if(overlay==100 ){
                ...
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:15%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else if(overlay==60){
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:10%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }else{
                jQuery("<style>.wpm_6310_team_style_07:hover .wpm_6310_team_style_07_content{ top:5%; }</style>").appendTo(".wpm_6310_tabs_panel_preview");
              }
        } 
      }) 
    })
      ...
      $member_readmore_info = (isset($allSlider[18]) && $allSlider[18])?'wpm_6310_team_member_info_readmore':' wpm_6310_team_member_info';
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_07  {$member_readmore_info}' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_07  {$member_readmore_info}' link-id='0' team-id='{$value['id']}'";
              } else {
                ...
                <div<?php echo $link_type ?>>
                  ...
                  <figcaption>
                    <div class="wpm_6310_team_style_07_content">
                      <div class="wpm_6310_team_style_07_title"><?php echo wpm_6310_replace($value['name']) ?></div>
                      <div class="wpm_6310_team_style_07_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                      <?php
                      ...
                      if ($icons) {
                        ...
                        foreach ($icons as $li) {
                          ...
                          if ($c == 0) {
                            echo "<ul class='wpm_6310_team_style_07_social'>";
                          }
                          $c++;
