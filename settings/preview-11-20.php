...
if (!empty($_POST['submit']) && $_POST['submit'] == 'Save' && $_POST['style'] != '') {
  ...
  if (!wp_verify_nonce($nonce, 'wpm-nonce-field')) {
    ...
    if ($_POST['style'] == 'template-11') {
      $css = "3|wpm_6310_team_style_hover_animation_top|0|0|rgba(48, 48, 48, 1)||nai|rgba(0, 0, 0, 0.8)|0|0|rgba(0, 0, 0, 0.74)|22|rgb(255, 255, 255)|||400|capitalize|Amaranth|28|16|rgb(255, 255, 255)|100|capitalize|Amaranth|24||35|35|1||3";
      ...
      $css = "3||0|0|rgba(48, 48, 48, 1)||nai|rgba(0, 0, 0, 0.8)|0|0|rgba(0, 0, 0, 0.74)|22|rgb(255, 255, 255)|||400|capitalize|Amaranth|50|16|rgb(255, 255, 255)|100|capitalize|Amaranth|24||35|35|1||3";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 255, 255, 1)|0|rgba(0, 150, 136, 1)|rgba(0, 150, 136, 1)|100|capitalize|left|Amaranth|0|20||||||left|5|0||||||||left|20|0||||||||";
    } else if ($_POST['style'] == 'template-13') {
      $css = "3||0|1|rgba(255, 0, 0, 1)||nai|rgba(242, 242, 242, 0.96)|0|0|rgba(161, 161, 161, 0.74)|22|rgb(0, 0, 0)|||100|uppercase|Amaranth|28|14|rgb(117, 117, 117)|300|uppercase|Amaranth|20||35|35|1||0";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 33, 33, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|0|20||||||center|0|0||||||||center|0|0||||||||";
    } else if ($_POST['style'] == 'template-14') {
      $css = "3||0|0|rgba(0, 0, 0, 0.9)||nai|rgba(255, 255, 255, 1)|0|0|rgba(5, 5, 5, 1)|20|rgb(0, 0, 0)|||600|uppercase|Amaranth|26|14|rgb(0, 0, 0)|200|uppercase|Amaranth|24||35|35|1||1";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 33, 33, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|0|15||||||center|15|0||||||||center|0|0||||||||";
    } else if ($_POST['style'] == 'template-15') {
      $css = "3||0|0|rgba(168, 3, 0, 1)||nai|rgba(0, 0, 0, 0.6)|0|0|rgba(145, 0, 0, 1)|20|rgb(255, 255, 255)|||600|uppercase|Amaranth|24|14|rgb(203, 149, 225)|200|uppercase|Amaranth|20||35|35|1||1";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 255, 255, 1)|0|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|5|20||||||center|20|0||||||||center|0|5||||||||";
    } else if ($_POST['style'] == 'template-16') {
      $css = "3||0|1|rgba(156, 136, 185, 0.7)||nai|rgba(243, 245, 247, 0.77)|0|0|rgba(143, 0, 0, 1)|20|rgb(31, 31, 31)|||700|uppercase|Amaranth|26|14|rgb(120, 120, 120)|100|uppercase|Amaranth|22||35|35|1||0";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 33, 33, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|0|20||||||center|5|20||||||||center|20|0||||||||";
    } else if ($_POST['style'] == 'template-17') {
      $css = "3||0|10|rgba(1, 22, 39, 1)||nai|rgba(46, 196, 182, 1)|0|0|rgba(255, 255, 255, 1)|20|rgb(1, 22, 39)|rgb(46, 196, 182)|rgb(255, 255, 255)|bold|uppercase|Amaranth|26|14|rgb(231, 29, 54)|300|uppercase|Amaranth|18||35|35|1||1";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 33, 33, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|1|20||||||center|5|0||||||||center|0|10|||||||||";
    } else if ($_POST['style'] == 'template-18') {
      $css = "3||0|1|rgba(161, 161, 161, 1)||nai|rgba(0, 0, 0, 0.55)|0|0|rgba(31, 179, 170, 1)|22|rgb(255, 255, 255)|||100|uppercase|Amaranth|43|14|rgb(255, 255, 255)|100|uppercase|Amaranth|20||35|35|1||10";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 255, 255, 1)|0|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|0|20||||||center|0|0||||||||center|10|10||||||||";
    } else if ($_POST['style'] == 'template-19') {
      $css = "3||0|1|rgba(37, 173, 96, 1)||nai|rgba(38, 173, 96, 0.44)|0|0|rgba(0, 255, 111, 0.45)|20|rgb(42, 66, 132)|||600|uppercase|Amaranth|26|14|rgb(69, 69, 69)|200|uppercase|Amaranth|24||35|35|1||10";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(255, 33, 33, 1)|2|rgba(0, 150, 136, 1)|rgba(204, 49, 90, 1)|100|capitalize|center|Amaranth|0|20||||||center|5|0||||||||center|10|10||||||||";
    } else if ($_POST['style'] == 'template-20') {
      $css = "3||0|10|rgba(60, 50, 107, 1)||nai|rgba(60, 51, 107, 0.71)|0|0|rgba(145, 0, 0, 1)|20|rgb(60, 50, 107)|||500|capitalize|Amaranth|26|14|rgb(60, 50, 107)|200|capitalize|Amaranth|20||35|35|1||1";
      $slider .= "|1|Read More|35|120|15|rgba(255, 255, 255, 1)|rgba(255, 255, 255, 1)|1px|rgba(60, 50, 107, 1)|0|rgba(0, 150, 136, 1)|rgba(60, 50, 107, 1)|100|capitalize|center|Amaranth|0|20||||||center|0|0||||||||center|0|10||||||||";
    }
      ...
      <div class="wpm-6310-col-4">
        <div class="wpm_6310_team_style_12">
          ...
          <div class="wpm_6310_team_style_12_team_content">
            ...
            <div class="wpm_6310_team_style_12_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
              sit amet ipsum ut quam faucibus dictum a sit amet lorem.</div>
